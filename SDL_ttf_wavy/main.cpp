...
int main()
{
	...
	TTF_Init();
	TTF_Font* myFont = TTF_OpenFont("Arial.ttf", 100);
	...
	unsigned texture = renderText( "HELLO WORLD", myFont, color, textWidth, textHeight );
	float fTextWidth = (float)textWidth/SCREEN_WIDTH;
	float fTextHeight = (float)textHeight/SCREEN_HEIGHT;
	
	// vertices
	// format: x, y, texture_x, texture_y
	const GLfloat vertices[] =
	{
		-fTextWidth/2.0f, fTextHeight/2.0f, 0, 0,
		fTextWidth/2.0f, fTextHeight/2.0f, 1, 0,
		fTextWidth/2.0f, -fTextHeight/2.0f, 1, 1,
		-fTextWidth/2.0f, -fTextHeight/2.0f, 0, 1
	};
